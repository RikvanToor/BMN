...
import { Form as BootstrapForm, Button, FormGroup, ControlLabel, FormControl } from 'react-bootstrap';

let BmnFormContext = React.createContext();
...
class Form extends Component {
    ...
    render() { 
        let {tag, ...props} = this.props;
        let WrapComp = tag ? tag : BootstrapForm; 
        return ( 
            <WrapComp {...props}>
                <BmnFormContext.Provider value={this.contextProvider}>
                    ...
                    {(context)=>{
                        return React.Children.map(this.props.children, (child)=>
                            React.cloneElement(child,{formContext: context})
                        );  
                    }}
                    </BmnFormContext.Consumer>
...
export class FormField extends Component{
    ...
    render(){
        let {label, controlId, validationState, formContext, onChange, type, options, ...props} = this.props;
        let fgProps = {};
...
export class SubmitButton extends Component{
    ...
    render(){
        let {onClick, formContext, tag, ...props} = this.props;
        let ButtonComp = tag ? tag : Button;
        return (
